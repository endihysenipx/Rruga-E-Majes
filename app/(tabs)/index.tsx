...
export default function JourneyHomeScreen() {
  ...
  return (
    <Screen>
      ...
      <MountainHero journey={journey} title={t(journey.nameKey)} story={t(journey.storyKey)} currentSteps={currentSteps} regionLabel={t(`regions.${journey.regionId}`)} />
...
const styles = StyleSheet.create({
  topbar: { flexDirection: 'row', alignItems: 'center', paddingVertical: spacing.lg, gap: spacing.md }, avatar: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.emerald, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' }, welcome: { flex: 1 }, currency: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: 13, paddingVertical: 9, backgroundColor: colors.surface, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.border },
  ...
  error: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.md }, flex: { flex: 1 }, hint: { textAlign: 'center', marginTop: spacing.sm }, sectionTitle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: spacing.xl, marginBottom: spacing.md },
